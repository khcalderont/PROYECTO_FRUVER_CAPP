    ...
    public class ClienteData
    {
        ...
        public static bool GuardarCliente(ClientesEntity cliente)
        {
            MySqlConnection conex = ConexionBD();
                ...
                conex.Open();
                string sql = @"INSERT INTO `tbclientes`(`TipoDocumento`, `NumeroDocumento`, `PrimerNombre`, `SegundoNombre`, 
                               `PrimerApellido`, `SegundoApellido`, `Email`, `Direccion`, `Telefono`, `FechaNacimiento`)
                             VALUES 
                             (@TipoDocumento,@NumeroDocumento,@PrimerNombre,@SegundoNombre,
                             @PrimerApellido,@SegundoApellido,@Email,@Direccion,
